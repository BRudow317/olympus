...
BEGIN
    ...
    /* Corrected by removing the illegal "COLUMNS" keyword */
    ...
    INSERT INTO qbl.http_codes (code, description, reference) VALUES(104,'Upload Resumption Supported','[draft-ietf-httpbis-resumable-upload-05](TEMPORARY - registered 2024-11-13, extension registered 2025-09-15, expires 2026-11-13)');
    ...
    -- Permanently save changes to database dictionary
    COMMIT;
EXCEPTION
    WHEN OTHERS THEN
